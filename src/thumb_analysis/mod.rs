...
pub(crate) use artifact::{
    ...
    read_thumb_artifact, read_thumb_functions_bytes, read_thumb_functions_file,
    read_thumb_functions_streaming, stream_rewrite_json_array, stream_rewrite_json_array_trusted,
    stream_rewrite_thumb_functions, stream_rewrite_thumb_functions_trusted,
    validate_thumb_inventory_bytes, validate_thumb_inventory_streaming,
};
