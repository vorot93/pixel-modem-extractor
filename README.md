...
`01_MAIN`. A recognized map lives at `images/<MAIN>/scatter/` and a validated PAL plan at
`images/<MAIN>/pal_tasks/tasks.json` on either model; both survive `--prune`. `rf/` appears only
